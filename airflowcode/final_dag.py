...
import emr_dependencies as emr
import pandas as pd
...
def copy_data(**kwargs):
    ...
    DESTINATION_KEY = "/".join(dest_path_list[3:])# (Leave blank if root level, include slash at end if Prefix specified)
    print(SOURCE_BUCKET, SOURCE_KEY, DESTINATION_BUCKET, SOURCE_KEY)
...
dag_args = {
    ...
    'email': ['saurav.jha@tigeranalytics.com'],
